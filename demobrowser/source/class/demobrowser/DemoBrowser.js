...
qx.Class.define("demobrowser.DemoBrowser",
{
  ...
  */
  ...
  construct : function()
  {
    ...
    this.widgets = {};
    this.tests = {};
    this.__currentTheme = "calc.theme.Theme";
  ...
  */
  ...
  members :
  {
    ...
    __makeToolBar : function()
    {
      ...
      var t1 = new qx.ui.menu.RadioButton("Default");
      var t2 = new qx.ui.menu.RadioButton("Default");

      t1.setUserData("value", "calc.theme.Theme");
      t1.setValue(true);
      t2.setUserData("value", "calc.theme.Theme");
    ...
    setCurrentSample : function(value)
    {
      ...
      if (treeNode)
      {
        ...
        url = 'demo/' + value + "?qxsetting:qx.theme:" + this.__currentTheme;
      }
      else
      {
        url = this.defaultUrl;

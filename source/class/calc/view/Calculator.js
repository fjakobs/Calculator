qx.Class.define("calc.view.Calculator",
{
  ...
  members :
  {
    ...
    */
    ...
    {    
      this._buttons =
      {
        "MC": new calc.view.Button("MC", 0, 0),
        "M+": new calc.view.Button("M+", 0, 1),
        "M-": new calc.view.Button("M-", 0, 2),
        "MR": new calc.view.Button("MR", 0, 3),

        "C": new calc.view.Button("C", 1, 0),
        "sign": new calc.view.Button("&plusmn;", 1, 1),
        "/": new calc.view.Button("&divide;", 1, 2, null, null, "/"),
        "*": new calc.view.Button("*", 1, 3, null, null, "*"),

        "7": new calc.view.Button("7", 2, 0, null, null, "7"),
        "8": new calc.view.Button("8", 2, 1, null, null, "8"),
        "9": new calc.view.Button("9", 2, 2, null, null, "9"),
        "-": new calc.view.Button("-", 2, 3, null, null, "-"),

        "4": new calc.view.Button("4", 3, 0, null, null, "4"),
        "5": new calc.view.Button("5", 3, 1, null, null, "5"),
        "6": new calc.view.Button("6", 3, 2, null, null, "6"),
        "+": new calc.view.Button("+", 3, 3, null, null, "+"),
        
        "1": new calc.view.Button("1", 4, 0, null, null, "1"),
        "2": new calc.view.Button("2", 4, 1, null, null, "2"),
        "3": new calc.view.Button("3", 4, 2, null, null, "3"),
        "=": new calc.view.Button("=", 4, 3, 2, null, "Enter"),

        "0": new calc.view.Button("0", 5, 0, null, 2, "0"),
        ".": new calc.view.Button(
    ...
    */   
    ...
    _createChildControlImpl : function(id)
    {
      if (id === "display") 
      {
        var display = new calc.view.Display();
